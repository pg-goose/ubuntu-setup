...
Config.instname = "UPC - Universitat Politècnica de Catalunya"
Config.profilename = "General Profile"
Config.url = "http://www.upcnet.es/atic"
Config.email = "atic@upcnet.es"
Config.title = "eduroam CAT"
Config.server_match = "triangulum.upc.es"
...
Config.user_realm = "upc.edu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:triangulum.upc.es']
Config.use_other_tls_id = False
Config.anonymous_identity = "cat.202010081836@upc.edu"
Config.tou = """When logging in this service you acquire the condition of user. This user condition necessarily implies the acceptance without reservations of any kind, each and every one of the terms of the following use conditions in https://www.upc.edu/en/disclaimer/terms-of-use-and-privacy-policy.

In compliance with the provisions of the General Data Protection Regulation (GDPR) and the Spanish organic Law 3/2018 of protection of personal data and guarantee of digital rights (LOPDGDD), we inform you that your personal data collected through access to this service will be processed and will be incorporated into the processing "Management of the network access register" of the UPC. You will find more information at this address: https://rat.upc.edu/ca/registre-de-tractaments-de-dades-personals/F04.4

When logging in the service you accept this privacy policy. However, we inform you can exercise your rights of access, rectification, erasure and object to the Data Protection Officer at the e-mail address proteccio.dades@upc.edu.
